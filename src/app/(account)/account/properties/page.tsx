                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4 text-sm text-slate-500">
                                            ...
                                            <span
                                                className={`px-2 py-0.5 rounded-full text-xs font-medium ${typeConfig[property.type].color
                                                    }`}
                                            >
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow group">
                ...
                <div className="relative h-48 bg-slate-100">
                    ...
                    <div className="absolute top-3 left-3 flex gap-2">
                        <span
                            className={`px-2.5 py-1 rounded-full text-xs font-medium ${typeConfig[property.type].color
                                }`}
                        >
                            {typeConfig[property.type].label}
                        </span>
